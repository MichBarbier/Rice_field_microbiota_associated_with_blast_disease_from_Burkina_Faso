...
library("GMPR") # Allows data normalisation    ---> The GMPR normalisation method is now available with the package : GUniFrac
...
# Noramlisation of the ASV counts with the GMPR method from the package GUniFrac 
library("GUniFrac")
Size_factors <- GMPR(Data[,8:94])
Data[,8:94] <- t(t(Data[,8:94])/Size_factors)
